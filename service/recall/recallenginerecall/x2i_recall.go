...
func NewRecallEngineX2IRecall(client *recallengine.RecallEngineClient, conf recconf.RecallEngineConfig) *RecallEngineX2IRecall {
	...
	r := RecallEngineX2IRecall{
		...
		itemIdName:      conf.RecallEngineParams[0].ItemIdName,
...
func (r *RecallEngineX2IRecall) buildRequest(user *module.User, context *context.RecommendContext) *be.ReadRequest {
...
func (r *RecallEngineX2IRecall) BuildQueryParams(user *module.User, context *context.RecommendContext) (ret map[string]string) {
