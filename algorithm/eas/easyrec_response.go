...
// GetEmbeddings returns the embedding matrix, or nil for legacy single-vector responses.
func (r *TorchrecEmbeddingResponse) GetEmbeddings() [][]float32 { return r.multiEmbeddings }
