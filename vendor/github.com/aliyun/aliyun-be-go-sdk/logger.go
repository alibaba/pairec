...
func initDefaultBELogger() log.Logger {
	logFileName := os.Getenv("BE_GO_SDK_LOG_FILE_NAME")
	isJsonType := os.Getenv("BE_GO_SDK_IS_JSON_TYPE")
	logMaxSize := os.Getenv("BE_GO_SDK_LOG_MAX_SIZE")
	logFileBackupCount := os.Getenv("BE_GO_SDK_LOG_FILE_BACKUP_COUNT")
	allowLogLevel := os.Getenv("BE_GO_SDK_ALLOW_LOG_LEVEL")
